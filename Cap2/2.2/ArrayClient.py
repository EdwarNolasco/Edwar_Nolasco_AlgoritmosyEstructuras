...
print("Deleting max number returns", arr.deleteMaxNum())
...
#print("Max number in the array:", arr.deleteMaxNum())
#print("Array after deleting max number has", len(arr), "items")
#arr.traverse()