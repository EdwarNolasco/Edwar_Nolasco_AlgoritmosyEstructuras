...
class Array(object):
    ...
    #Este método crea una nueva lista vacía llamada unique y luego itera
    #sobre cada elemento en la matriz original. Si un elemento aún no está
    #en unique, se agrega. Luego, unique se convierte en la nueva matriz y
    #su longitud se establece como la cantidad de elementos en ella.
